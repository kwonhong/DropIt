...
public class FlyOutContainer2 extends LinearLayout {
        ...
        public FlyOutContainer2(Context context, AttributeSet attrs) {
                super(context, attrs);
        }

        public FlyOutContainer2(Context context) {
                super(context);
        }
        ...
        protected void onLayout(boolean changed, int left, int top, int right,
                ...
                this.content.layout(left , top, right
                               , bottom);
        ...
        public void toggleMenu() {
                ...
                case CLOSED:
                        ...
                        this.menuAnimationScroller.startScroll(-this.getMenuWidth(), 0, this.getMenuWidth(),
                                        0, menuAnimationDuration);
                        break;
                case OPEN:
                        this.menuCurrentState = MenuState.CLOSING;
                        this.menuAnimationScroller.startScroll(0,
                                0, -this.getMenuWidth(), 0, menuAnimationDuration);
        ...
        private void adjustContentPosition(boolean isAnimationOngoing) {
                ...
                String temp = "" + scrollerOffset;
                Log.i("1235", temp);
                this.menu.offsetLeftAndRight(scrollerOffset
        ...
        protected class AnimationRunnable implements Runnable {
                ...
                @Override
                public void run() {
                        FlyOutContainer2.this
                                        .adjustContentPosition(FlyOutContainer2.this.menuAnimationScroller
                                                        .computeScrollOffset());
                }
